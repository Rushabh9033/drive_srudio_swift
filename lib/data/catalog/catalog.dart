  ...
  static final templates = <TemplateItem>[
    ...
    TemplateItem(
      ...
      spec: WidgetSpec(
        ...
        layers: [
          baseLayer(
            LayerKind.divider,
            overrides: {'x': 12, 'y': 20, 'w': 76, 'h': 1, 'color': '#2A2F3A'},
          ),
          baseLayer(
            LayerKind.divider,
            overrides: {'x': 12, 'y': 80, 'w': 76, 'h': 1, 'color': '#2A2F3A'},
          ),
          baseLayer(
            LayerKind.text,
            overrides: {
    ...
    TemplateItem(
      ...
      spec: _spec('#132118', '#20463A', [
        baseLayer(
          LayerKind.badge,
          overrides: {'text': 'TRIP', 'x': 12, 'y': 12, 'color': '#4DC98A'},
        ),
        baseLayer(
          LayerKind.clock,
          overrides: {
        ...
        baseLayer(
          LayerKind.divider,
          overrides: {'x': 12, 'y': 68, 'w': 36, 'color': '#4DC98A'},
        ),
        baseLayer(
          LayerKind.date,
          overrides: {
    ...
    TemplateItem(
      ...
      spec: _spec('#16181D', '#2A2F3A', [
        baseLayer(
          LayerKind.shape,
          overrides: {'x': 10, 'y': 12, 'w': 26, 'h': 26, 'color': '#2A2F3A'},
        ),
        baseLayer(
          LayerKind.text,
          overrides: {
        ...
        baseLayer(
          LayerKind.clock,
          overrides: {'x': 12, 'y': 78, 'fontSize': 12, 'weight': 500, 'h': 14},
        ),
      ]),
    ),
    TemplateItem(
    ...
    TemplateItem(
      ...
      spec: _spec('#101A2B', '#2C4C7C', [
        ...
        baseLayer(
          LayerKind.clock,
          overrides: {'x': 12, 'y': 54, 'fontSize': 16, 'weight': 600, 'h': 16},
        ),
    ...
    TemplateItem(
      ...
      spec: _spec('#1A1509', '#3A2E12', [
        baseLayer(
          LayerKind.badge,
          overrides: {'text': 'LOAD', 'x': 12, 'y': 12, 'color': '#E5B84A'},
        ),
        baseLayer(
          LayerKind.battery,
          overrides: {
        ...
        baseLayer(
          LayerKind.divider,
          overrides: {'x': 12, 'y': 86, 'w': 50, 'color': '#E5B84A'},
        ),
      ]),
    ),
    TemplateItem(
      ...
      spec: _spec('#0F141C', '#1A3348', [
        baseLayer(
          LayerKind.shape,
          overrides: {'x': 8, 'y': 8, 'w': 84, 'h': 18, 'color': '#1E2A3A'},
        ),
        baseLayer(
          LayerKind.text,
          overrides: {
        ...
        baseLayer(
          LayerKind.divider,
          overrides: {'x': 12, 'y': 64, 'w': 32, 'color': '#4D9EFF'},
        ),
        baseLayer(
          LayerKind.text,
          overrides: {
    ...
    TemplateItem(
      ...
      spec: _spec('#120E18', '#2A1838', [
        ...
        baseLayer(
          LayerKind.divider,
          overrides: {'x': 12, 'y': 82, 'w': 40, 'color': '#4D9EFF'},
        ),
        baseLayer(
          LayerKind.date,
          overrides: {'x': 56, 'y': 80, 'fontSize': 11, 'color': '#A8B6CC'},
        ),
      ]),
    ),
    TemplateItem(
      ...
      spec: _spec('#12180F', '#2A3A1C', [
        ...
        baseLayer(
          LayerKind.shape,
          overrides: {'x': 70, 'y': 14, 'w': 18, 'h': 18, 'color': '#2A3A1C'},
        ),
        baseLayer(
          LayerKind.clock,
          overrides: {'x': 12, 'y': 56, 'fontSize': 18, 'weight': 700, 'h': 18},
        ),
        baseLayer(
          LayerKind.text,
          overrides: {
    ...
    TemplateItem(
      ...
      spec: _spec('#1A100C', '#3A2218', [
        ...
        baseLayer(
          LayerKind.clock,
          overrides: {'x': 12, 'y': 36, 'fontSize': 34, 'weight': 800, 'h': 30},
        ),
        baseLayer(
          LayerKind.text,
          overrides: {
        ...
        baseLayer(
          LayerKind.divider,
          overrides: {'x': 12, 'y': 90, 'w': 36, 'color': '#E05A45'},
        ),
      ]),
    ),
    TemplateItem(
